// Generated using Heron on Sun Apr 08 2018 17:40:52 GMT-0400 (Eastern Daylight Time)
...
{
  return array_853(op_sub_509(upto,from),(i) => op_add_485(i,upto));
}
// (Func (Array T0) Int T0)
...
function quadStripToMeshIndices_870(vertices, rows)
{
  ...
  {
    const r = op_dot_dot_1287(0,rows).at(i4);
    {
      for (let i5=0; i5 < op_dot_dot_1287(0,cols).count; ++i5)
      {
        const c = op_dot_dot_1287(0,cols).at(i5);
        {
          let a = op_add_485(c,op_mul_533(r,cols));
